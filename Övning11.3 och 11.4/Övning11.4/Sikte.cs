...
namespace Övning11._4
{
    class Sikte
    {
        ...
        public void Rita(Graphics g)
        {
            ...
            g.DrawEllipse(sikteKantFarg, _x, _y, radie * 2, radie * 2);
            g.DrawLine(sikteFarg, _x + radie, _y, _x + radie, _y + radie * 2);
            g.DrawLine(sikteFarg, _x, _y + radie, _x + radie * 2, _y + radie);
        }
    }
}
